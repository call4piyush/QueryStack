package com.querystack.models;

import java.util.List;

import com.querystack.dto.Question;
import com.querystack.dto.User;
import com.querystack.service.UserService;
...
public class RegisterBL {
	...
	/*
	 * public User login(String email, String password){ return
	...
	/*
	 * public boolean registerUser(User user) { userService.createAccount(user);
	 * return true;
	 * 
	 * }
	 */
