...
import com.querystack.dto.sorting.SortOnAns;
import com.querystack.dto.sorting.SortOnVotes;
import com.querystack.dto.sorting.SortOnVotesPlusAns;
...
public class IndexController {
	...
	public ModelAndView get(HttpServletRequest request,
		...
		List<Question> list = myList
				.subList((pageNo - 1) * pageSize, ((pageNo - 1) * pageSize)
						+ pageSize > myList.size() ? ((pageNo - 1) * pageSize)
						+ temp : ((pageNo - 1) * pageSize) + pageSize);
	...
	public void getIndexsort(HttpServletRequest request,
			HttpServletResponse response, @RequestParam("sortBy") String sortBy) {
		...
		try {
			request.getRequestDispatcher("indexReal.spring?page=1&pagesize=5")
	...
	public void get(HttpServletRequest request, HttpServletResponse response,
		...
		for (Iterator<Question> iterator = myList.iterator(); iterator
				.hasNext();) {
			Question question = (Question) iterator.next();
			List<String> tagList = question.getTagList();
			for (Iterator<String> iterator2 = tagList.iterator(); iterator2
					.hasNext();) {
