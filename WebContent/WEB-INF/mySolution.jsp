...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="myIndex.spring?page=1&pagesize=5">
					QueryStack</a>
			</div>
	...
	<div class="container">
		...
		<div class="jumbotron">
			<h2>Query Stack</h2>
			<p>Query Stack is a question and answer site for professional and
					...
					<div class="row alert alert-warning">
						<div class="col-md-1">
							<ul class="list-unstyled">
								<li><a href="#" id="likeQues"><img
										src="resources/images/like.jpg" class="img-rounded" width="24"
										height="24" /></a></li>
								<li><label class="label label-info" id="quesVotes">${key.ques.votes}</label></li>
								<li><a href="#" id="disLikeQues"><img
										src="resources/images/dislike.jpg" class="img-rounded"
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a id="makeFavQues" href="#"><img
												src="resources/images/favorite.jpg" class="img-rounded"
												width="24" height="24" /></a></li>
									</c:otherwise>
								</c:choose>
								<!-- /Favourit Question Logic -->
						...
						<div class="col-md-11">
							<p class="text-info">
								<b>${key.ques.quesTitle}</b>
							</p>
							<p>${key.ques.ques}</p>
							<hr>
							<c:forEach var="tag" items="${key.ques.tagList}">
								<span class="pull-left"> <a
									class="btn btn-success btn-xs" role="button">${tag}</a> <!-- <a class="btn btn-success btn-xs" role="button">Java</a> 
     <a class="btn btn-success btn-xs" role="button">C++</a> -->
								</span>
							</c:forEach>
							<span class="pull-right"> by <a role="button">${key.ques.name}</a>
								on ${key.ques.date}
							</span>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="row alert alert-success">
							<div class="col-md-1">
								...
								<ul class="list-unstyled">
									<li><a href="#" id="likeSol"><img
											src="resources/images/like.jpg" class="img-rounded"
											width="24" height="24" /></a></li>
									<li><label class="label label-info" id="solVotes">${sol.votes}</label></li>
									<li><a href="#" id="disLikeSol"><img
											src="resources/images/dislike.jpg" class="img-rounded"
											width="24" height="24" /></a></li>
							...
							<div class="col-md-11">
								...
								<hr>
								<span class="pull-left">By <a href="#">${key.session.name}</a><b>&nbsp;
										Reputation: 100</b></span> <span class="pull-right"> ${sol.date}</span>
							</div>
						</div>
						<input type="hidden" id="solId" value="${sol.solId }">
					</div>
				</c:forEach>
				...
				<div class="col-mid-12">
					<hr>
					<form class="form-horizontal"
						action="submitSolution.spring?quesId=${key.ques.quesId}"
						...
						<textarea class="form-control" id="inputEmail3"
							name="solutionText" placeholder="Your solution goes here!"
							rows="10"></textarea>
