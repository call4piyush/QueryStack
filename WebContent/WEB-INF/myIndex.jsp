		...
		<div class="jumbotron">
			...
			<p class="pull-right">
				...
				<a class="btn btn-default btn-primary"
					href="/jsp/AddUser.jsp" role="button">Users</a> <a
						...
						<div class="row alert alert-warning">
							<div class="col-md-2">
								<ul class="nav nav-pills nav-stacked">
									<li class="active"><a> <span class="badge pull-right">${ques.votes }</span>
											Votes
									</a></li>
									<li class="active"><a> <span class="badge pull-right">${ques.ans }</span>
											Ans.
									</a></li>
								</ul>
...
<li class="list-group-item text-center">${ques.ans }<br>Ans.</li>
							...
							<div class="col-md-10">
								<p class="text-info">
									<b><a href="solution.spring?quesId=${ques.quesId }">${ques.quesTitle }</a></b>
								</p>

								<hr>
								<c:forEach var="tag" items="${ques.tagList}">
									<span class="pull-left"> <a
										class="btn btn-success btn-xs" href="tags.jsp" role="button">${tag }</a>
									</span>
								</c:forEach>
								<span class="pull-right"> by <a role="button">${ques.name }</a>
									${ques.date }
								</span>
							</div>
						</div>
