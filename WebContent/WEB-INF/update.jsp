...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.html"> QueryStack</a>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="col-md-3">
					<img alt="Change Picture" src="resources/images/default_image.jpg"
						class="thumbnail" />
				</div>
				<div class="col-md-9">

					<form class="form-horizontal" action="updateData.spring"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="email" class="form-control" id="inputEmail3"
									name="emailId" value="${key.emailId }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="hidden" class="form-control" id="inputPassword3"
									name="password" value="${key.password }"> <input
									type="hidden" class="form-control" id="inputPassword3"
