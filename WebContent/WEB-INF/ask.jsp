...
<link rel="shortcut icon"
	href="..//bootstrap-3.0.2-dist//docs-assets//ico//favicon.png">
...
<body>
    ...
    <a class="btn btn-default btn-primary" href="../../components/#navbar" role="button">Users</a>  -->
				<a class="btn btn-default btn-warning disabled"
					href="../../components/#navbar" role="button">Ask Question </a>
			</p>
		</div>
		<!-- /Jumbotron-->
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<form class="form-horizontal" action="quesSubmitReal.spring"
					method="post" role="form">
					<h3>
						<label class="label label-primary form-control">Question:</label>
					</h3>
					<input type="text" class="form-control" id="inputEmail3"
						name="quesTitle" placeholder="What is your question?" /> <br>
					<h3>
						<label class="label label-primary form-control">Question
							Explaination:</label>
					</h3>
					<textarea class="form-control" id="inputEmail3" name="ques"
						placeholder="Tell more about your question." rows="10"></textarea>

					<br>
					<h3>
						<label class="label label-primary form-control">Related
							Tags:</label>
					</h3>
        ...
        <span class="col-lg-2">  <input type="checkbox"> OOP</span>
					...
					<c:forEach var="tag" items="${key.list}">
						<input type="checkbox" name="tagList" value="${tag}" />
						<c:out value="${tag}" />
					</c:forEach>
					<br> <br>
					<hr>
			...
			<div class="col-md-4">
				<div class=" alert-danger">
					<div class="page-header">
						<h4>Tips: Before asking new question...</h4>
					</div>
		...
		<script
			src="${pageContext.request.contextPath}/resources/js/onload.js"></script>
		<script
			src="${pageContext.request.contextPath}/resources/js/jquery.js"
