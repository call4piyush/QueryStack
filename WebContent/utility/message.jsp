...
%>
			<c:out value="You are not logged in currently, Press here to "></c:out>
			<a href='Login_Signup.jsp'>Login/Signup</a>
			</p>
			<p class="pull-right">
				...
				<a class="btn btn-default btn-primary"
					...
					class="btn btn-default btn-warning" href="ask.html" role="button">Ask
					Question </a>
			</p>
		</div>
		<!-- /Jumbotron-->
