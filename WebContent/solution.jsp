						...
						<div class="col-md-11">
							...
							<c:forEach var="tag" items="${key.ques.tagList}">
								<span class="pull-left"> <a
									class="btn btn-success btn-xs" id="hi" role="button">${tag}</a>
     ...
     <a class="btn btn-success btn-xs" role="button">C++</a> -->
					...
					<div class="col-md-12">
						<div class="row alert alert-success">
							...
							<div class="col-md-11">
								...
								<hr>
								<span class="pull-left">By <a href="#">${sol.name}</a><b>&nbsp;
				...
				<div class="col-mid-12">
					...
					<form class="form-horizontal"
						...
						<textarea class="form-control" id="solutionAjax"
