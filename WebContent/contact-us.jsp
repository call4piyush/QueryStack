...
<script type="text/javascript">
      function initialize() {
        var mapOptions = {
          center: new google.maps.LatLng(12.8435694,77.664635),
          zoom: 16
        };
	...
	<div class="container" style="margin-top: 60px;">
		...
		<div class="row">
			...
			<div class="col-xs-6 col-md-6">
				<div class="well">
					<b>C-DAC Bengaluru</b><br> 68, Electronic City Phase-1<br>
					Electronic City<br> Bengaluru - 560100<br> Karnataka
					(India)<br> Phones: +91-80-28523300<br> Fax:
					+91-80-28522590<br>
